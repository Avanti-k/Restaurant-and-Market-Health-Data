...
async function find(context) {
  ...
  if (context.id) {
    ...
    query = `  
SELECT table1.YR_qtr as "qtr", table1.mode_vcode as "mode_own", table1.cnt_ins as "own_avg", table2.mode_vcode as "mode_all", table2.cnt_ins as "all_avg"
FROM 
...
inner join violation on violation.ins_id = inspection.ins_id
where emp_ID <> :emp_id))
GROUP BY YR_qtr)t4 where t3.YR_qtr = t4.YR_qtr)table2
on table2.YR_qtr = table1.YR_qtr
